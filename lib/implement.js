...
function handleObjects(actual, expected, cb) {
	...
	for (var i = 0; i < commonKeys.length; i++) {
		key = commonKeys[i];
		assertIsValueOfType(actual[key], expected[key], typeErrorHash, key)
	}
...
function assertIsValueOfType(actualVal, expectedVal, typeErrorHash, key) {
...
/*
	TODOs:
	------
	* Support expected object like: 
		{a: 0, b:'', c:new Date()}
		{a: 'number', b: 'string', c: 'object'}
		{a: 'number', b: '', c: {d: 'boolean', e: []}}
